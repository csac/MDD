...
setup_app = Proc.new do |env|
  cas_server = URI.parse("https://authentification-cerbere.application.i2/cas")
  if cas_server
...
Devise.setup do |config|
  ...
  config.mailer_sender = "no-reply@#{MY_DOMAIN}"
  ...
  # config.pepper = "1618322d31ff13dc6a9a3cf270afdb853f73acadd24c69389f83d18dbef1a2092c8f092c996447240506d4f728ddae56c6c45a5ffe67a9536a6da160551cd877"
